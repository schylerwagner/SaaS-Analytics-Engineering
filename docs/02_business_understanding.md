...
Design and implement an end-to-end analytics engineering solution that transforms operational SaaS data into a structured, analytics-ready data model. The project simulates the early phases of a modern data warehouse by ingesting raw business data, validating data quality, applying standardized transformations, and preparing the data for downstream reporting and analytical use.
...
The termination of a customer's relationship with the platform.

Within this dataset, churn is modeled as an account-level business event and includes additional context such as:
...
These metrics may later be used to evaluate customer health, product adoption, and churn risk.
...
- Business metrics will be derived from validated and standardized data rather than directly from raw operational records.
